    ...
    <div class="container">
        <div class="main-footer">
            <div class="navbar">
                <div class="kolom1">
                    <div class="navbar">
                        <img src="../img/logo.png" alt="" style="width:26px;">
        ...
        <div class="lisensi-footer" style="padding-top: 20px">
            <div class="navbar">
                <div class="kolom1">
                    <p style="letter-spacing: -0.0001em; font-weight:lighter;">Copyright @kelompok8 - 2022</p>
                </div>
                <div class="kolom2">
                    <p>Licensed by Kelompok8</p>
                </div>
                <div class="kolom3">
