        ...
        <div class="navbar">
            ...
            <div class="about" style="float: left; width:55%; height:550px; padding:10px;">
                <div class="tentang">
                    ...
                    <br><br>
                    <h5 style="text-align: justify; color: #002f3a; line-height:28px;">Kelainan tulang adalah penyakit yang mempengaruhi sistem muskuloskeletal; yaitu sistem gerak yang terdiri dari tulang, otot, ligamen, dan sendi
                    <br>Kami memebangun sebuah aplikasi yang dapat mendiagnosa kemungkinan dari penyakit atau kelainan tulang melalui gejala gejala yang diderita pasien</h5>
                </div>
            </div>
