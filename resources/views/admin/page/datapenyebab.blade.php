...
@section('title' , 'Data Penyebab' , 'active')
			...
			<div class="page-inner">
				<div class="page-header">
					...
					<ul class="breadcrumbs">
						...
						<li class="nav-item">
							<a href="/admin/datapenyebab">Data Penyebab</a>
						</li>
					</ul>
				</div>
				<div class="row">
														...
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	<form action="{{ route('datapenyebab.store') }}" method="POST">
																		@csrf
																	<div>
																	<label>Kode Penyebab</label>
																	<input type="text" class="form-control" name="kode_penyebab" readonly value="{{ $kode }}" placeholder="masukan kode gejala" style="border: 1px solid #f1f1f1; line-height:40px; padding-left:10px;">
																	<br>
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
																		...
																		<div class="modal-content">
																			...
																			<div class="modal-body">
																				<div class="row">
																					<div class="col-sm-12">
																						<div class="form-group form-group-default">
																							<form action="{{ route('datapenyebab.update', $data->id) }}" method="POST">
																								@method('put')
																								@csrf
																							
																								<div>
																									<label>Kode Penyebab</label>
																									<input type="text" class="form-control" disabled value="{{ $data->kode_penyebab }}" name="kode_penyebab" placeholder="masukan kode gejala" style="border: 1px solid #f1f1f1; line-height:40px; padding-left:10px;">
																									<br>
																									<label>Penyebab</label>
																									<input type="text" class="form-control" value="{{ $data->nama_penyebab }}" name="nama_penyebab" placeholder="masukan gejala" style="border: 1px solid #f1f1f1; line-height:40px; padding-left:10px;">
																									{{-- <br>
																									<label>Bobot</label>
															...
															<form action="{{ route('datapenyebab.destroy',$data->id) }}" method="POST">
																@csrf
																@method('delete')
