...
@section('title' , 'Data Gejala' , 'active')
														...
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	<form action="{{ route('datagejala.store') }}" method="POST">
																		@csrf
																	<div>
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
																		...
																		<div class="modal-content">
																			...
																			<div class="modal-body">
																				<div class="row">
																					<div class="col-sm-12">
																						<div class="form-group form-group-default">
																							<form action="{{ route('datagejala.update', $data->id) }}" method="POST">
																								@method('put')
																								@csrf
																							
																								<div>
																									<label>Kode Gejala</label>
																									<input type="text" class="form-control" disabled value="{{ $data->kode_gejala }}" name="kode_gejala" placeholder="masukan kode gejala" style="border: 1px solid #f1f1f1; line-height:40px; padding-left:10px;">
																									<br>
																									<label>Gejala</label>
															...
															<form action="{{ route('datagejala.destroy',$data->id) }}" method="POST">
																@csrf
																@method('delete')
