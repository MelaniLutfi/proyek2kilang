...
@section('title' , 'Data Diagnosa' , 'active')
														...
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	...
																	<div>
																	<label>Nama</label>
																	<input type="text" class="form-control" name="kode_gejala" value="" placeholder="masukan kode gejala" style="border: 1px solid #f1f1f1; line-height:40px; padding-left:10px;" readonly>
																	<br>
																	<label>Gejala</label>
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
																						...
																						<div class="form-group form-group-default">
																							<form action="" method="POST">
																								...
																								<div>
																									...
																									<input type="text" class="form-control" disabled value="" name="kode_gejala" placeholder="masukan kode gejala" style="border: 1px solid #f1f1f1; line-height:40px; padding-left:10px;">
																									<br>
																									<label>Gejala</label>
																									<input type="text" class="form-control" value="" name="nama_gejala" placeholder="masukan gejala" style="border: 1px solid #f1f1f1; line-height:40px; padding-left:10px;">
																								</div>
															...
															<form action="{{ route('datadiagnosa.destroy',$data->id) }}" method="POST">
																@csrf
																@method('delete')
