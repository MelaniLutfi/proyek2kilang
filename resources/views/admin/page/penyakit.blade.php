...
@section('title' , 'Data Penyakit' , 'active')
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
																		...
																		<div class="modal-content">
																			...
																			<div class="modal-body">
																					<div class="row">
																						<div class="col-sm-12">
																							<div class="form-group form-group-default">
																								<form action="{{ route('datapenyakit.update', $data->id) }}" method="POST">
																									@method('put')
																									@csrf
																								<div>
																								<label>Kode Penyakit</label>
																								<input type="text" class="form-control" disabled value="{{ $data->kode_penyakit }}" name="kode_penyakit" placeholder="masukan kode penyakit" style="border: 1px solid #f1f1f1; line-height:40px; padding-left:10px;">
																								<br>
																								<label>Nama Penyakit</label>
																								...
																								<br>
																								<label>Deskripsi Penyakit</label>
																								<textarea name="deskripsi" class="form-control" id="" cols="30" rows="10" value="{{ $data->nama_penyakit }}" style="border: 1px solid #f1f1f1; padding-left:10px;">{{ $data->deskripsi }}</textarea>
																								{{-- <input type="text" class="form-control" name="nama_penyakit" value="{{ $data->nama_penyakit }}" placeholder="masukan nama penyakit" style="border: 1px solid #f1f1f1; line-height:40px; padding-left:10px;"> --}}
																								<br>
															...
															<form action="{{ route('datapenyakit.destroy', $data->id) }}" method="POST">
																@csrf
																@method('delete')
